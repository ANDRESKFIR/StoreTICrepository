			...
			<div class="card-body" style="border:#198754 1px solid">
				<form class="form-sign" action="DarBajaAction.jsp" method="POST">
					...
					<img alt="" width="300" src="img/BannerStoreTIC2.png"/>
						...
						<input style="background-color:#198754;color:#FFFFFF;border:#198754 1px solid" type="submit" name="accion" value="Darme de Baja" class="btn btn-warning btn" >
					</div>
				</form>
				<div class="row row-cols-lg-7 g-1">
					...
					%>
						<strong style="color:#198754" class="text-center">Cliente eliminado satisfactoriamente</strong>
					<% } %>
					<%
